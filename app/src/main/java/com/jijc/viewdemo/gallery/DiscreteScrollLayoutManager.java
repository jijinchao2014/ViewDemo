package com.jijc.viewdemo.gallery;
...
class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected boolean isFirstInCenter = false;
    ...
    public DiscreteScrollLayoutManager(
            ...
            boolean isFirstInCenter, @NonNull DSVOrientation orientation) {
        this.context = c;
        ...
        this.isFirstInCenter = isFirstInCenter;
    ...
    protected void layoutView(RecyclerView.Recycler recycler, int position, Point viewCenter) {
        ...
        if (v == null) {
            ...
            recyclerViewProxy.layoutDecoratedWithMargins(v,
                    viewCenter.x - childHalfWidth-(isFirstInCenter ? 0:childHalfHeight), viewCenter.y - childHalfHeight,
                    viewCenter.x + (isFirstInCenter ? childHalfHeight : 0) , viewCenter.y + childHalfHeight);
        } else {
