...
public class DiscreteScrollView extends RecyclerView {
    ...
    private boolean isFirstInCenter = false;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            isFirstInCenter = ta.getBoolean(R.styleable.DiscreteScrollView_is_first_center,false);
            ta.recycle();
        }
        ...
        layoutManager = new DiscreteScrollLayoutManager(
                getContext(), new ScrollStateListener(),isFirstInCenter,
