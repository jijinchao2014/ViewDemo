 ...
 */
public class CircleRoundedBitmapDisplayer implements BitmapDisplayer {

    protected final int margin;


    public CircleRoundedBitmapDisplayer(int marginPixels) {
    ...
    public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
        ...
        int cornerRadius = bitmap.getHeight() > bitmap.getWidth() ? bitmap.getWidth() : bitmap.getHeight();
